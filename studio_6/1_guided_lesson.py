...
student_3_id = 73648744
student_3_first_name = "Torrey"
student_3_last_name = "Kanko"
...
#The information could be too big/lengthy. A function good help with this.
...
class Student:
    ...
    def __init__(self, id, first_name, last_name, major, graduatuion_year):
        self.__id = id
        self.first_name = first_name
        self.last_name = last_name
        self.major = major
        self.graduation_year = graduatuion_year
    ...
    def print_degree_title_bachelor(self):
        print("Bachelor of " + self.major)
    
# TODO: Let's recreate our 3 students as objects of our new class!


student_1 = Student(18584831, "Dan", "White", "Computer Science", "2026")
student_2 = Student(18582185, "Jennie", "Kim", "Chemistry", "2025")
student_3 = Student(73648744, "Torrey", "Kanko", "Computer Science", "2027")
...
class GradStudent(Student):
    def __init__(self, id, first_name, last_name, major, graduatuion_year, specialization):
        super().__init__(id, first_name, last_name, major, graduatuion_year)
        self.specialization = specialization
    def print_degree_title_master(self):
...
student_4 = GradStudent(64815268, "Elon", "Musk", "Computer Science", "2023", "A.I.")
...
print(student_4.print_degree_title_bachelor())
...
print(student_4.print_degree_title_master())
